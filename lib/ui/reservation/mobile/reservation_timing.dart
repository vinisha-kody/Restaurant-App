...
import 'package:restaurant/ui/reservation/helper/reservation_timing_breakfast_tab_bar.dart';
import 'package:restaurant/ui/reservation/helper/reservation_timing_dinner_tab_bar.dart';
import 'package:restaurant/ui/reservation/helper/reservation_timing_lunch_tab_bar.dart';
import 'package:restaurant/ui/theme/app_font_style.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

class ReservationTiming extends ConsumerStatefulWidget {
  const ReservationTiming({super.key});

  @override
  ConsumerState<ReservationTiming> createState() => _ReservationTimingState();
}

class _ReservationTimingState extends ConsumerState<ReservationTiming> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xffF9F3F2),
      body: Column(
        children: [
          ...
          Expanded(
            child: TabBarView(
              controller: tabController,
                children: const [
                  ReservationTimingBreakfastTabBar(),
                  ReservationTimingLunchTabBar(),
                  ReservationTimingDinnerTabBar()
                ]
            ),
          )
        ],
